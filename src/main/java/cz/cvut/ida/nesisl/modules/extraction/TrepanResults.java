...
import main.java.cz.cvut.ida.nesisl.modules.extraction.trepan.MofNTreeRuleSetComplexity;
...
/**
 * should be renamed to ExtractionResults
 *
...
public class TrepanResults {
    ...
    private final Double trepanTrainAccuracy;
    ...
    private TrepanResults(Long numberOfInnerNodes, Double trepanTrainAccuracy, Double trepanTestAccuracy, Double trainFidelity, Double testFidelity, Double networkTrainAcc, Double networkTestAcc, Long mOfNDecisionTreeDescriptionLength, File tree) {
        this.numberOfInnerNodes = numberOfInnerNodes;
        this.trepanTrainAccuracy = trepanTrainAccuracy;
    ...
    public static TrepanResults create(Long numberOfInnerNodes, Double trepanTrainAccuracy, Double trepanTestAccuracy, Double trainFidelity, Double testFidelity, Double networkTrainAcc, Double networkTestAcc, Long mOfNDecisionTreeDescriptionLength, File tree) {
        return new TrepanResults(numberOfInnerNodes, trepanTrainAccuracy, trepanTestAccuracy, trainFidelity, testFidelity, networkTrainAcc, networkTestAcc, mOfNDecisionTreeDescriptionLength, tree);
    }
}
