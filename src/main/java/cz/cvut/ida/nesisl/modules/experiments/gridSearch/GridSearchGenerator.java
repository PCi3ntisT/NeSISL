...
public class GridSearchGenerator {
    ...
    private static GridSearchGenerator generateCascadeCorrelationSearch(String folder, String settingName) {
        ...
        map.put(CascadeCorrelationSetting.POOL_SIZE_LIMIT_TOKEN, orderedList("1", "4", "8"));
        map.put(CascadeCorrelationSetting.EPSILON_CONVERGENT_TOKEN, orderedList("0.1", "0.3"));
        map.put(CascadeCorrelationSetting.HIDDEN_NODE_LIMIT_TOKEN, orderedList("300"));
        map.put(CascadeCorrelationSetting.SHORT_TIME_WINDOW_TOKEN, orderedList("10", "20"));
        map.put(CascadeCorrelationSetting.LONG_TIME_WINDOW_TOKEN, orderedList("30", "60"));
        map.put(CascadeCorrelationSetting.CANDIDATE_ITERATION_LEARNING_LIMIT_TOKEN, orderedList("3000"));
    ...
    private static GridSearchGenerator generateREGENTSearch(String folder, String settingName) {
        Map<String, List<String>> map = new HashMap<>();
        // regent part
        map.put(RegentSetting.TOURNAMENT_SIZE_TOKEN, orderedList("2", "4"));
        map.put(RegentSetting.POPULATION_SIZE_TOKEN, orderedList("20", "50", "100"));
        ...
        map.put(TopGenSettings.OMEGA_TOKEN, orderedList("2.0", "4.0", "6.0"));
        map.put(TopGenSettings.SUCCESSORS_GENERATED_LIMIT_TOKEN, orderedList("5", "10", "25"));
        map.put(TopGenSettings.OPEN_LIST_LIMIT_TOKEN, orderedList("30", "65", "100"));
        map.put(TopGenSettings.SHORT_TIME_WINDOW_TOKEN, orderedList("10", "20"));
        map.put(TopGenSettings.LONG_TIME_WINDOW_TOKEN, orderedList("30", "60"));
        map.put(TopGenSettings.EPSILON_CONVERGENT_TOKEN, orderedList("0.001", "0.01", "0.1", "0.3"));
        map.put(TopGenSettings.LEARNING_RATE_DECAY_TOKEN, orderedList("0.1", "0.5", "0.8"));
        return new GridSearchGenerator(map, new File(folder),settingName);
    }
    ...
    private static GridSearchGenerator generateDNCSearch(String folder, String settingName) {
        ...
        map.put(DNCSetting.TIME_WINDOW_TOKEN, orderedList("5","15"));
        map.put(DNCSetting.CA_TOKEN, orderedList("0.001"));
        map.put(DNCSetting.CM_TOKEN, orderedList("0.01"));
        map.put(DNCSetting.HIDDEN_NODE_LIMIT_TOKEN, orderedList("300"));
        return new GridSearchGenerator(map, new File(folder),settingName);
    }

    private static GridSearchGenerator generateKBANNSearch(String folder, String settingName) {
        Map<String, List<String>> map = new HashMap<>();
        map.put(KBANNSettings.OMEGA_TOKEN, orderedList("2.0", "4.0", "6.0"));
        return new GridSearchGenerator(map, new File(folder),settingName);
    }

    private static GridSearchGenerator generateWLSSearch(String folder, String settingName) {
        Map<String, List<String>> map = new HashMap<>();
        map.put(WeightLearningSetting.EPSILON_TOKEN, orderedList("0.1", "0.3"));
        map.put(WeightLearningSetting.EPOCH_TOKEN, orderedList("3000"));
        map.put(WeightLearningSetting.LEARNING_RATE_TOKEN, orderedList("0.1", "0.4", "0.9"));
        map.put(WeightLearningSetting.MOMENTUM_ALPHA_TOKEN, orderedList("0.01", "0.1", "0.3", "0.9"));
