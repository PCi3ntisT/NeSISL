...
import main.java.cz.cvut.ida.nesisl.modules.neural.algorithms.structuralLearningWithSelectiveForgetting.StructuralLearningWithSelectiveForgetting;
...
public class OldMain {
    ...
    private NeuralNetwork simpleNetwork() {
        ...
        Node n11 = NodeFactory.createTest(Sigmoid.getFunction());
        Node n12 = NodeFactory.createTest(Sigmoid.getFunction());
        Node n13 = NodeFactory.createTest(Sigmoid.getFunction());

        Node n20 = NodeFactory.createTest(Sigmoid.getFunction());
